...
# message box is used to display pop up messages
import time
...
class StackVisualizer:
    def __init__(self, root):
        self.window = root
        self.window.config(bg="white")  # set background color of window
        ...
        self.number = IntVar()  # holds integer data
        self.value_entry = IntVar()  # accepts integer data
        self.value_entry.set(" ")  # to show entry box empty

        # Default coordinate set
        self.canvas_width = 600  # window width
        self.canvas_height = 500  # window height
        ...
        # Make canvas
        self.stack_canvas = Canvas(self.window, width=self.canvas_width, height=self.canvas_height, bg="sky blue",
                                   relief=RAISED, bd=10)  # relief gives 3D effect to button
        self.stack_canvas.pack(fill=BOTH)  # used to occupy the given space
    ...
    def heading_and_sub_heading(self):  # Main heading, sub heading and indicator label set
        self.heading_name = Label(self.stack_canvas, text="Stack Visualizer", bg="sky blue", fg="black",
                                  font=("Helvetica", 30, "bold", "italic"))  # heading
        self.heading_name.place(x=140, y=30)

        self.sub_heading = Label(self.stack_canvas, text="Index number", bg="sky blue", fg="black",
                                 font=("Helvetica", 20, "bold", "italic"))
        self.sub_heading.place(x=20, y=300)

        self.stack_indicator = Label(self.stack_canvas, text="Stack Container", bg="sky blue", fg="black",
                                     font=("Helvetica", 20, "bold", "italic"))
        self.stack_indicator.place(x=180, y=450)

    def make_buttons(self):  # Make Buttons to access and make top with arrow
        self.push_btn = Button(self.window, text="PUSH", fg="white", bg="black", font=("Arial", 15, "bold"),
                               relief=RAISED, bd=7, command=self.push_element)
        self.push_btn.place(x=30, y=535)

        self.pop_btn = Button(self.window, text="POP", fg="white", bg="black", font=("Arial", 15, "bold"),
                              relief=RAISED, bd=7, command=self.pop_data)
        self.pop_btn.place(x=500, y=535)

        self.top_index = Label(self.window, text="<---- top", fg="black", bg="sky blue", font=("Arial", 20, "bold"))
    ...
    def set_index(self):  # Index of the stack set
        self.index_neg = Label(self.stack_canvas, text="-1", fg="black", bg="sky blue", font=("Arial", 15, "bold"))
        self.index_neg.place(x=215, y=403)

        self.index_0 = Label(self.stack_canvas, text="0", fg="black", bg="sky blue", font=("Arial", 15, "bold"))
        self.index_0.place(x=220, y=365)

        self.index_1 = Label(self.stack_canvas, text="1", fg="black", bg="sky blue", font=("Arial", 15, "bold"))
        self.index_1.place(x=220, y=332)

        self.index_2 = Label(self.stack_canvas, text="2", fg="black", bg="sky blue", font=("Arial", 15, "bold"))
        self.index_2.place(x=220, y=299)

        self.index_3 = Label(self.stack_canvas, text="3", fg="black", bg="sky blue", font=("Arial", 15, "bold"))
        self.index_3.place(x=220, y=266)

        self.index_4 = Label(self.stack_canvas, text="4", fg="black", bg="sky blue", font=("Arial", 15, "bold"))
        self.index_4.place(x=220, y=232)

        self.index_5 = Label(self.stack_canvas, text="5", fg="black", bg="sky blue", font=("Arial", 15, "bold"))
    ...
    def push_element(self):  # Push button action
        if len(self.last_label_value_keep) == 6:
            ...
            self.add_btn = Button(self.window, text="Add", font=("Arial", 10, "bold"), bg="black", fg="white",
    ...
    def make_block(self, e):  # Element containing block making
        try:
            ...
            self.entry_number = Label(self.stack_canvas, textvar=self.number, bg="black", fg="white",
                                      font=("Arial", 11, "bold"))
    ...
    def reset_with_position_set(self):  # Reset the coordinate value
        ...
        self.final_set_block = Label(self.window, text=self.value_entry.get(), bg="black", fg="white",
                                     font=("Arial", 11, "bold"))
